      ...
      <?php
        ...
        ?>
                           <form action="" method="post" id="f">
                               <div id="h2"><h2>Edit your post</h2></div>
                            <input type="text" name="title" value=<?php echo $post_title?> size="69%" required="required"><br>
                            <textarea placeholder="Write something..." name="content" cols="40" rows="4"><?php echo $post_con; ?></textarea><br>
                            <select name="topic">
