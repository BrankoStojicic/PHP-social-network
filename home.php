                        ...
                        <div id="content_timeline">
                          <div id="frame">
                           <form action="home.php?id=<?php echo $user_id; ?>" method="post" id="f">
                               <div id="h2"><h2>Any new topics today?</h2></div>
                            <input type="text" name="title" placeholder="Write a title" size="69%" required="required"><br>
                            <textarea placeholder="Write something..." name="content" cols="40" rows="4"></textarea><br>
                            <select name="topic">
                            ...
                            ?>
                                ...
                                <div id="MRD"><h3>Most Recent Discussions</h3></div>
                                <?php get_posts(); ?>
